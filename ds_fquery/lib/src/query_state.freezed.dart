...
mixin _$QueryState<TData, TError> {
  ...
  @JsonKey(ignore: true)
  $QueryStateCopyWith<TData, TError, QueryState<TData, TError>> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $QueryStateCopyWith<TData, TError, $Res> {
  factory $QueryStateCopyWith(QueryState<TData, TError> value, $Res Function(QueryState<TData, TError>) then) =
...
/// @nodoc
class _$QueryStateCopyWithImpl<TData, TError, $Res, $Val extends QueryState<TData, TError>> implements $QueryStateCopyWith<TData, TError, $Res> {
...
/// @nodoc
abstract class _$$QueryStateImplCopyWith<TData, TError, $Res> implements $QueryStateCopyWith<TData, TError, $Res> {
  factory _$$QueryStateImplCopyWith(_$QueryStateImpl<TData, TError> value, $Res Function(_$QueryStateImpl<TData, TError>) then) =
...
/// @nodoc
class __$$QueryStateImplCopyWithImpl<TData, TError, $Res> extends _$QueryStateCopyWithImpl<TData, TError, $Res, _$QueryStateImpl<TData, TError>>
    implements _$$QueryStateImplCopyWith<TData, TError, $Res> {
  __$$QueryStateImplCopyWithImpl(_$QueryStateImpl<TData, TError> _value, $Res Function(_$QueryStateImpl<TData, TError>) _then) : super(_value, _then);
...
class _$QueryStateImpl<TData, TError> extends _QueryState<TData, TError> with DiagnosticableTreeMixin {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.dataUpdatedAt, dataUpdatedAt) || other.dataUpdatedAt == dataUpdatedAt) &&
            (identical(other.errorUpdatedAt, errorUpdatedAt) || other.errorUpdatedAt == errorUpdatedAt) &&
            (identical(other.isFetching, isFetching) || other.isFetching == isFetching) &&
            (identical(other.status, status) || other.status == status) &&
            (identical(other.isInvalidated, isInvalidated) || other.isInvalidated == isInvalidated) &&
            (identical(other.fetchMeta, fetchMeta) || other.fetchMeta == fetchMeta) &&
            (identical(other.isRefetchError, isRefetchError) || other.isRefetchError == isRefetchError));
  }

  @override
  int get hashCode => Object.hash(runtimeType, const DeepCollectionEquality().hash(data), const DeepCollectionEquality().hash(error), dataUpdatedAt,
      errorUpdatedAt, isFetching, status, isInvalidated, fetchMeta, isRefetchError);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$QueryStateImplCopyWith<TData, TError, _$QueryStateImpl<TData, TError>> get copyWith =>
      __$$QueryStateImplCopyWithImpl<TData, TError, _$QueryStateImpl<TData, TError>>(this, _$identity);
}
...
abstract class _QueryState<TData, TError> extends QueryState<TData, TError> {
  ...
  @override
  @JsonKey(ignore: true)
  _$$QueryStateImplCopyWith<TData, TError, _$QueryStateImpl<TData, TError>> get copyWith => throw _privateConstructorUsedError;
}
